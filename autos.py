...
eng = pyttsx3.init()
eng.setProperty("rate",140)#Configuracion de la velocidad de la pronunciacion
eng.setProperty("volume",1.0)#Establecer el nivel de volumen de la voz
eng.runAndWait()#Establecemos la voz a utilizar
